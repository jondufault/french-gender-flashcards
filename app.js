(function () {
  ...
  var ENDINGS = [
    ...
    { ending: "-ment", gender: "m", examples: "le moment, le mouvement, le gouvernement", exceptions: "(aucune)", category: "masc" },
    { ending: "-er", gender: "m", examples: "le danger, le papier, l'escalier", exceptions: "la mer", category: "masc" },
    { ending: "-al", gender: "m", examples: "le journal, l'animal, l'hôpital", exceptions: "(aucune)", category: "masc" },
    { ending: "-el", gender: "m", examples: "le ciel, l'hôtel, l'appel", exceptions: "(aucune)", category: "masc" },
    { ending: "-et", gender: "m", examples: "l'effet, le projet, le sujet", exceptions: "(aucune)", category: "masc" },
    { ending: "-ant", gender: "m", examples: "l'enfant, le restaurant, l'enseignant", exceptions: "(aucune)", category: "masc" },
    { ending: "-in", gender: "m", examples: "le matin, le chemin, le jardin", exceptions: "la main, la fin", category: "masc" },
    { ending: "-it", gender: "m", examples: "l'esprit, le fruit, le bruit", exceptions: "la nuit", category: "masc" },
    { ending: "-ent (pas -ment)", gender: "m", examples: "l'argent, le président, l'accident", exceptions: "la dent", category: "masc" },
    { ending: "-ail / -eil", gender: "m", examples: "le travail, le soleil, le conseil", exceptions: "(aucune)", category: "masc" },
    { ending: "-oir", gender: "m", examples: "l'espoir, le miroir, le pouvoir", exceptions: "(aucune)", category: "masc" },
    { ending: "-eu / -ieu", gender: "m", examples: "le dieu, le jeu, le lieu", exceptions: "(aucune)", category: "masc" },
    { ending: "-ien", gender: "m", examples: "le chien, le soutien, l'entretien", exceptions: "(aucune)", category: "masc" },
    // Feminine endings
    ...
    { ending: "-oire", gender: "f", examples: "l'histoire, la mémoire, la victoire", exceptions: "le territoire, le laboratoire, le pourboire", category: "fem" },
    ...
    { ending: "-ière", gender: "f", examples: "la rivière, la lumière, la frontière", exceptions: "l'arrière, le cimetière", category: "fem" },
